...
import factset.sampleapi.auth.Authentication;
import factset.sampleapi.auth.HttpBasicAuth;
import factset.sampleapi.auth.HttpBearerAuth;
import factset.sampleapi.auth.ApiKeyAuth;

import factset.sampleapi.auth.OAuth;
...
public class ApiClient {
  ...
  public ApiClient() {
    ...
    setUserAgent("sample-api/0.0.0/java");
